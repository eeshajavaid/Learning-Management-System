...
public class Withdraw_Course {
    ...
    public void initGUI()
    {
        ...
        List <String> registeredCourses = C.GetStudentCourse(name);
         c.setLayout( new GridLayout((registeredCourses.size()+1),2 ));
        for(int i=0; i < registeredCourses.size(); i++)
        {
         ...
         WithDraw_Listener w = new WithDraw_Listener(name, checkbox, registeredCourses);
    ...
    Withdraw_Course(String student_name)
    {
        name = student_name;
        initGUI();
    }
