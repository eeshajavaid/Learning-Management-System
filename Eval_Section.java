 ...
 * @author Eesha Javaid
 */
public class Eval_Section extends javax.swing.JFrame {

    /**
     * Creates new form Eval_Section
     */
    String course;
    public Eval_Section(String course) {
        initComponents();
    ...
    private void nextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nextMouseClicked
        // TODO add your handling code here:
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Evaluation(course,Sectionlist.getSelectedValue()).setVisible(true);
            }
        });
            }
            else
